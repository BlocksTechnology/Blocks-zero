...
#  else
    ...
    lcd.print("mm");
   // f=current_position[Z_AXIS];
    //sprintf(zheight, "%d.%02d mm", (int)f, (int)(f*100)%100);
    //sprintf(zheight,"%f",current_position[Z_AXIS]);
    //SERIAL_ECHOLN(String(zheight));
    //SERIAL_ECHOLN(current_position[Z_AXIS]);
    //dtostrf(f, 2, 2, &zheight[strlen(zheight)]);
    //lcd.print(zheight);
   //lcd.print(ftostr32sp(current_position[Z_AXIS] + 0.00001));
    /*lcd.print('X');
